<template>
    <div id="MainLayout" class="h-screen">
        <div class="w-full max-w-[500px] mx-auto">
            <div id="TopManu" class="w-full flex items-center justify-center px-2 h-10 my-2">
        ...
        <div
            id="BottomNav"
            class="fixed z-50 bottom-0 flex w-full h-[70] border-t border-t-gray-700 bg-black"
        >
